...
SWIFT_CLASS("_TtC8nexxPlay21NexxPlayOfflineEngine")
@interface NexxPlayOfflineEngine : NSObject
@property (nonatomic, strong) PlayerView * _Nonnull playerView;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)initializeWithDomain:(NSString * _Nonnull)domain userId:(NSString * _Nonnull)userId userHash:(NSString * _Nonnull)userHash session:(NSString * _Nonnull)session completionBlock:(void (^ _Nonnull)(NSError * _Nullable))completionBlock;
- (void)startMediaDownloadWithMediaId:(NSString * _Nonnull)mediaId streamType:(NSString * _Nonnull)streamType;
- (void)startLocalPlaybackWithMediaId:(NSString * _Nonnull)mediaId streamType:(NSString * _Nonnull)streamType completionBlock:(void (^ _Nonnull)(NSError * _Nullable))completionBlock;
- (void)deleteLocalMediaWithMediaId:(NSString * _Nonnull)mediaId completionBlock:(void (^ _Nonnull)(NSError * _Nullable))completionBlock;
- (void)clearLocalMediaWithCompletionBlock:(void (^ _Nonnull)(NSError * _Nullable))completionBlock;
- (void)listLocalMediaWithCompletionBlock:(void (^ _Nonnull)(NSArray<NSDictionary<NSString *, NSString *> *> * _Nullable))completionBlock;
- (void)terminateWithCompletionBlock:(void (^ _Nonnull)(NSError * _Nullable))completionBlock;
...
- (void)disableFullscreenCloseButton;
- (NSArray<NSDictionary<NSString *, id> *> * _Nullable)getCaptionDataForLanguage:(NSString * _Nullable)language SWIFT_WARN_UNUSED_RESULT;
- (void)disableWatermark;
- (void)setPlayerFullscreen;
