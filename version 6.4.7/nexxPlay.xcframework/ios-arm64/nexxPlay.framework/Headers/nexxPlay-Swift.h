...
@property (nonatomic) NSInteger startMuted;
@property (nonatomic) NSInteger adStartWhenMuted;
...
@property (nonatomic) NSInteger campaign;
...
@property (nonatomic, copy) NSString * _Nonnull platformVariant;
@property (nonatomic) NSInteger platformVariantIndex;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull UnmuteAutoplay;)
+ (NSString * _Nonnull)UnmuteAutoplay SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)updateConfigurationWithPreUrl:(NSString * _Nonnull)preUrl midUrl:(NSString * _Nonnull)midUrl midInterval:(double)midInterval postUrl:(NSString * _Nonnull)postUrl bumperUrl:(NSString * _Nonnull)bumperUrl webURLRepresentation:(NSString * _Nonnull)webURLRepresentation;
- (void)clearCache;
- (void)play;
- (void)pause;
- (void)toggle;
...
- (NSArray<NSDictionary<NSString *, id> *> * _Nullable)getTextTracks SWIFT_WARN_UNUSED_RESULT;
