...
- (void)startPlayWithGlobalID:(NSString * _Nonnull)sessionID client:(NSString * _Nonnull)client globalID:(NSString * _Nonnull)globalID startPosition:(double)startPosition startItem:(NSInteger)startItem;
- (void)startPlayWithForeignReference:(NSString * _Nonnull)sessionID client:(NSString * _Nonnull)client playmode:(NSString * _Nonnull)playmode reference:(NSString * _Nonnull)reference provider:(NSString * _Nonnull)provider startPosition:(double)startPosition startItem:(NSInteger)startItem;
...
- (void)setContextReferenceWithContextReference:(NSString * _Nonnull)contextReference;
