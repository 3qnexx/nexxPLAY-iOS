...
- (void)swapToMediaItemWithMediaID:(NSString * _Nonnull)mediaID streamType:(NSString * _Nullable)streamType startPosition:(NSInteger)startPosition delay:(double)delay;
- (void)swapToGlobalIDWithGlobalID:(NSString * _Nonnull)globalID startPosition:(NSInteger)startPosition delay:(double)delay;
- (void)swapToRemoteMediaWithReference:(NSString * _Nonnull)reference provider:(NSString * _Nonnull)provider delay:(double)delay;
- (NSDictionary<NSString *, NSString *> * _Nonnull)getMediaData SWIFT_WARN_UNUSED_RESULT;
