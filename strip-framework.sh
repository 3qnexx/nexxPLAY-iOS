...
NEXXPLAY_FRAMEWORKS=`find $FRAMEWORKS_DIRECTORY -type d -name "nexxPlay.framework" -o -name "DailymeSdk.framework" -o -name "GoogleInteractiveMediaAds.framework"`

for framework in $NEXXPLAY_FRAMEWORKS; do
