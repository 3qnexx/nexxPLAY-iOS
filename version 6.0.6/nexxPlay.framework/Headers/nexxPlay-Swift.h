...
@property (nonatomic, copy) NSString * _Nonnull webURLReference;
@property (nonatomic, copy) NSString * _Nonnull streamingFilter;
@property (nonatomic, copy) NSString * _Nonnull startedVia;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull MetaDataLoaded;)
+ (NSString * _Nonnull)MetaDataLoaded SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull ShowUI;)
+ (NSString * _Nonnull)ShowUI SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull HideUI;)
+ (NSString * _Nonnull)HideUI SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull DownloadSuccess;)
+ (NSString * _Nonnull)DownloadSuccess SWIFT_WARN_UNUSED_RESULT;
...
- (void)setConfiguration:(NexxPLAYConfiguration * _Nonnull)configuration;
...
- (void)swapToRemoteMediaWithReference:(NSString * _Nonnull)reference provider:(NSString * _Nonnull)provider delay:(double)delay reason:(NSString * _Nullable)reason showReturnButton:(BOOL)showReturnButton;
- (NSDictionary<NSString *, id> * _Nonnull)getMediaData SWIFT_WARN_UNUSED_RESULT;
