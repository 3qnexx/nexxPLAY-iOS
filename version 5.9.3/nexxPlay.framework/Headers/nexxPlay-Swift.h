...
- (void)startPlay:(NSString * _Nonnull)sessionID client:(NSString * _Nonnull)client playmode:(NSString * _Nonnull)playmode param:(NSString * _Nonnull)param startPosition:(NSInteger)startPosition startItem:(NSInteger)startItem;
- (void)swap:(NSString * _Nonnull)param;
- (void)swapToPos:(NSString * _Nonnull)newParam;
- (void)swapComplex:(NSString * _Nonnull)playMode param:(NSString * _Nonnull)param startPosition:(NSInteger)startPosition startItem:(NSInteger)startItem;
...
- (NSDictionary<NSString *, NSString *> * _Nonnull)getMediaData;
