...
- (void)startPlayWithRemoteMedia:(NSString * _Nonnull)sessionID client:(NSString * _Nonnull)client playmode:(NSString * _Nonnull)playmode reference:(NSString * _Nonnull)reference provider:(NSString * _Nonnull)provider startPosition:(double)startPosition startItem:(NSInteger)startItem;
